...
class App(tk.Tk):
    ...
    def __init__(self, converter):
        tk.Tk.__init__(self)
        self.title = 'Ứng dụng chuyển đổi tiền tệ'
        self.currency_converter = converter

        self.geometry("500x200")
        
        self.intro_label = Label(self, text = 'Chương trình chuyển đổi tỷ giá tiền tệ',  fg = 'blue', relief = tk.RAISED, borderwidth = 3)
        ...
        self.to_currency_variable.set("VND") 
